(() => {
    ...
    window.onload = function() {
        ...
        } else preloader.classList.add("_show");
    };
    function isWebp() {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) {
            ...
            menuBody.addEventListener("click", (function(e) {
                if (document.documentElement.classList.contains("menu-open") && !e.target.closest(".menu__list")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                }
            }));
    ...
    function deleteActiveWindowLarger767px() {
        if (remSreenWidth()) if (document.querySelector(".icon-menu").classList.contains("_active") || document.documentElement.classList.contains("lock")) menuClose();
    }
    ...
    function menuListSubLists() {
        let menuListSubLists = document.querySelectorAll(".menu__list_sublist-title");
        if (menuListSubLists.length > 0) for (let index = 0; index < menuListSubLists.length; index++) {
            const menuListSubList = menuListSubLists[index];
            menuListSubList.addEventListener("click", (function(e) {
                if (document.documentElement.classList.contains("_touch") || !remSreenWidth()) if (!menuListSubList.parentElement.classList.contains("_active")) {
                    document.querySelectorAll(".menu__list_sublist").forEach((el => {
                        if (el.classList.contains("_active")) el.classList.remove("_active");
                    }));
                    menuListSubList.parentElement.classList.add("_active");
                } else menuListSubList.parentElement.classList.remove("_active");
            }));
            if (remSreenWidth()) {
    ...
    function initSliders() {
        ...
        } else if (document.querySelector(".swiper")) new core(".swiper", {
            modules: [ Navigation ],
            freeMode: true,
            observer: true,
            observeParents: true,
    ...
    if (colorSelectionsButtons.length > 0) for (let index = 0; index < colorSelectionsButtons.length; index++) {
    ...
    if (buttonsSwiperSlide.length > 0) for (let index = 0; index < buttonsSwiperSlide.length; index++) {
