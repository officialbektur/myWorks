...
export function minWindowScreen300() {
...
export function addTouchClass() {
	if (isMobile.any()) {
		if (document.documentElement.classList.contains("_pc")) {
			document.documentElement.classList.remove("_pc");
		}
...
/* ===================================  Progress Bar  --End--  =================================== */
export function remSreenWidth(mobileSreenWidth = 991.98) {
...
export function deleteActiveWindowLarger767px() {
	if (remSreenWidth()) {
		if (document.documentElement.classList.contains("icon-menu") || document.documentElement.classList.contains("lock")) {
			menuClose();
		}
	}
}
...
export function deleteActiveAtSublistOnPc() {
	if (document.documentElement.classList.contains("_pc")) {
...
/* ====================  Dropdown List  --Start--  ==================== */
export function menuListSubLists() {
	let menuListSubLists = document.querySelectorAll(".menu__list_sublist-title span");
	let menuListSubListButtons = document.querySelectorAll(".menu__list_sublist-title span");
	if (menuListSubListButtons.length > 0) {
		for (let index = 0; index < menuListSubListButtons.length; index++) {
			...
			menuListSubListButton.addEventListener("click", function (e) {
				if (document.documentElement.classList.contains("_touch") || !remSreenWidth()) {
					if (!menuListSubListButton.parentElement.parentElement.classList.contains("_active")) {
						...
						menuListSubListButton.parentElement.parentElement.classList.remove("_active");
					}
				}
			});
			if (remSreenWidth()) {
