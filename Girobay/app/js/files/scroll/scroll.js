// Подключение функционала functions.js
...
export function windowOnScroll() {
	if (document.querySelector('[data-activ-scroll]')) {
		...
		window.onscroll = function () {
			if (window.pageYOffset > activWhenScrollGet) {
				activWhenScroll.classList.add("_active");
			} else {
				activWhenScroll.classList.remove("_active");
			}
		}
	}
}
