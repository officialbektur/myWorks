(() => {
    ...
    (() => {
        ...
        if (document.querySelector(".preloader")) if (screenWidth > 250) {
        ...
        function minWindowScreen300() {
            let screenWidth = screen.width;
            let metaViewport = document.getElementById("metaViewport");
            if (screenWidth < 300) {
                document.body.classList.add("_minWindowScreen300");
                metaViewport.setAttribute("content", "width=1200");
            } else {
                document.body.classList.remove("_minWindowScreen300");
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) {
                ...
                let iconMenuBack = document.querySelector(".menu__body_back");
                let menuBodyAfter = document.querySelector(".menu__body");
                iconMenu.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-menu") && !remSreenWidth()) {
                        bodyLockToggle();
                        document.documentElement.classList.toggle("menu-open");
                    }
                }));
                iconMenuBack.addEventListener("click", (function(e) {
                    if (bodyLockStatus && !remSreenWidth()) {
                        menuClose();
                        document.documentElement.classList.remove("menu-open");
                    }
                }));
                menuBodyAfter.addEventListener("click", (function(e) {
                    if (!e.target.closest(".menu__body_content") && !e.target.closest(".top-menu__body") && !e.target.closest(".top-header__texts") && !e.target.closest(".menu__body_back") && !remSreenWidth()) {
                        bodyUnlock();
                        document.documentElement.classList.remove("menu-open");
                    }
                }));
        ...
        function remSreenWidth(mobileSreenWidth = 991.98) {
            let numberDefault = 16;
            let remSreenWidth = window.innerWidth / numberDefault;
            return mobileSreenWidth / numberDefault <= remSreenWidth;
        }
        function deleteActiveWindowLarger767px() {
            if (remSreenWidth()) if (document.documentElement.classList.contains("icon-menu") || document.documentElement.classList.contains("lock")) menuClose();
        }
        function deleteActiveAtSublistOnPc() {
            if (document.documentElement.classList.contains("_pc")) {
                ...
                if (menuListSublists.length > 0) for (let index = 0; index < menuListSublists.length; index++) {
                    const menuListSublist = menuListSublists[index];
                    if (menuListSublist.classList.contains("_active")) menuListSublist.classList.remove("_active");
                }
            }
        }
        function menuListSubLists() {
            document.querySelectorAll(".menu__list_sublist-title span");
            let menuListSubListButtons = document.querySelectorAll(".menu__list_sublist-title span");
            if (menuListSubListButtons.length > 0) for (let index = 0; index < menuListSubListButtons.length; index++) {
                const menuListSubListButton = menuListSubListButtons[index];
                menuListSubListButton.addEventListener("click", (function(e) {
                    if (document.documentElement.classList.contains("_touch") || !remSreenWidth()) if (!menuListSubListButton.parentElement.parentElement.classList.contains("_active")) {
                        document.querySelectorAll(".menu__list_sublist").forEach((el => {
                            if (el.classList.contains("_active")) el.classList.remove("_active");
                        }));
                        menuListSubListButton.parentElement.parentElement.classList.add("_active");
                    } else menuListSubListButton.parentElement.parentElement.classList.remove("_active");
                }));
                if (remSreenWidth()) {
                    menuListSubListButton.parentElement.parentElement.classList.contains("_active");
                    document.body.addEventListener("click", (function(e) {
                        if (!e.target.closest(".menu__list_sublist")) document.querySelectorAll(".menu__list_sublist").forEach((el => {
                            if (el.classList.contains("_active")) el.classList.remove("_active");
                        }));
                    }));
                }
        ...
        function initSliders() {
            if (document.querySelector(".hi__slider")) new core(".hi__slider", {
            ...
            if (!remSreenWidth(767.98)) if (document.querySelector(".popuplar__slider")) new core(".popuplar__slider", {
                modules: [ Pagination ],
                slidesPerView: 1.8,
                spaceBetween: 20,
                pagination: {
            ...
            if (document.querySelector(".block__slider")) new core(".block__slider", {
                modules: [ Navigation ],
                slidesPerView: 1.5,
                spaceBetween: 10,
                navigation: {
        ...
        function windowOnScroll() {
            if (document.querySelector("[data-activ-scroll]")) {
                let activWhenScroll = document.querySelector("[data-activ-scroll]");
                let activWhenScrollGet = activWhenScroll.getAttribute("data-activ-scroll");
                window.onscroll = function() {
                    if (window.pageYOffset > activWhenScrollGet) activWhenScroll.classList.add("_active"); else activWhenScroll.classList.remove("_active");
                };
            }
        }
        ...
        DynamicAdapt.prototype.init = function() {
            ...
            this.nodes = document.querySelectorAll("[data-responce]");
            for (let i = 0; i < this.nodes.length; i++) {
                const node = this.nodes[i];
                const data = node.dataset.responce.trim();
        ...
        const responce = new DynamicAdapt("max");
        responce.init();
        let buttonCatalogButton = document.querySelector(".button-catalog__icons");
        if (buttonCatalogButton) buttonCatalogButton.addEventListener("click", (function() {
        ...
        if (buttonCatalogBodyArrow) for (let index = 0; index < buttonCatalogBodyArrow.length; index++) {
            const element = buttonCatalogBodyArrow[index];
            element.addEventListener("click", (function() {
                if (!element.parentElement.parentElement.classList.contains("_active") && !remSreenWidth()) {
                    buttonCatalogBodyLi.forEach((index => {
                        if (index.classList.contains("_active")) index.classList.remove("_active");
                    }));
                    this.parentElement.parentElement.classList.add("_active");
                } else this.parentElement.parentElement.classList.remove("_active");
            }));
        }
        ...
        if (buttonLikes.length > 0) for (let index = 0; index < buttonLikes.length; index++) {
        ...
        if (buttonListPlus.length > 0) for (let index = 0; index < buttonListPlus.length; index++) {
        ...
        if (buttonBasket.length > 0) for (let index = 0; index < buttonBasket.length; index++) {
